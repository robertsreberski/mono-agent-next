...
| `@mono-agent/web` | `core` / `operator-surface` | Runs the standalone browser product with explicit token or trusted-network access and owner-private durable conversations. | [README for @mono-agent/web](./packages/web/README.md) |
...
| `@mono-agent/module-sdk` | `core` / `core` | Defines typed module, selected-instance tool, schema, compliance, and bounded host contracts. | [README for @mono-agent/module-sdk](./packages/module-sdk/README.md) |
