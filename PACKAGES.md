...
| `@mono-agent/web` | `core` / `operator-surface` | Runs the standalone browser product with explicit auth policy and owner-private durable conversations. | [README for @mono-agent/web](./packages/web/README.md) · [npm for @mono-agent/web](https://www.npmjs.com/package/@mono-agent/web) |
