...
| `@mono-agent/state-local` | `core` / `execution` | Provides owner-private CAS state, durable transcript/run records, RunHistory, idempotency, and presence publication. | [README for @mono-agent/state-local](./packages/state-local/README.md) · [npm for @mono-agent/state-local](https://www.npmjs.com/package/@mono-agent/state-local) |
...
| `@mono-agent/core` | `core` / `core` | Loads strict agent configuration, runs selected typed modules, and governs one callable-tool catalog. | [README for @mono-agent/core](./packages/core/README.md) · [npm for @mono-agent/core](https://www.npmjs.com/package/@mono-agent/core) |
| `@mono-agent/module-sdk` | `core` / `core` | Defines Apache-licensed typed module, selected-instance tool, schema, compliance, and bounded host contracts. | [README for @mono-agent/module-sdk](./packages/module-sdk/README.md) · [npm for @mono-agent/module-sdk](https://www.npmjs.com/package/@mono-agent/module-sdk) |
