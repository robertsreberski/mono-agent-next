...
| `@mono-agent/runtime-opencode` | `core` / `runtime` | Runs OpenCode JSONL process attempts with version preflight and bounded native session handling. | [README for @mono-agent/runtime-opencode](./packages/runtime-opencode/README.md) · [npm for @mono-agent/runtime-opencode](https://www.npmjs.com/package/@mono-agent/runtime-opencode) |
