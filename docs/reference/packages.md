...
| `@mono-agent/web` | `core` / `operator-surface` | Runs the standalone browser product with explicit token or trusted-network access and owner-private durable conversations. | [README for @mono-agent/web](https://github.com/robertsreberski/mono-agent-next/blob/main/packages/web/README.md) |
