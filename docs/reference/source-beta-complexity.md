...
Source manifest digest: `4e22da1b9cc84c810d1c13705b77afc4424f6cf52439ce8ece2c5539617ccabd`

## Lines of code

| Classification | Files | Physical lines |
| --- | ---: | ---: |
| Production | 195 | 78441 |
| Tests | 130 | 59626 |
| Repository and product tooling | 62 | 22463 |
| Checked-in generated source | 0 | 0 |
| **Total executable source** | **387** | **160530** |
...
Average production file size is 402.3 lines.

## Binding budgets

| Budget | Actual | Maximum | Result |
| --- | ---: | ---: | --- |
| repository-production | 78441 | 130000 | within limit |
...
| `@mono-agent/memory-local` | 14 | 6977 | 3158 |
| `@mono-agent/service-macos` | 14 | 4264 | 1806 |
