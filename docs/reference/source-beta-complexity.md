...
Source manifest digest: `9c5ee82cea4891a754afe8121eb1e7bee80cee0d5482fc87f747ff4bcf70f8ba`

## Lines of code

| Classification | Files | Physical lines |
| --- | ---: | ---: |
| Production | 311 | 95942 |
| Tests | 163 | 76236 |
| Repository and product tooling | 56 | 18848 |
| Checked-in generated source | 0 | 0 |
| **Total executable source** | **530** | **191026** |
...
Average production file size is 308.5 lines.

## Binding budgets

| Budget | Actual | Maximum | Result |
| --- | ---: | ---: | --- |
| repository-production | 95942 | 130000 | within limit |
...
| --- | ---: | ---: | --- |
| test source, at 0.75 of production | 76236 | 71957 | within limit |
...
| `@mono-agent/memory-local` | 19 | 8124 | 4753 |
