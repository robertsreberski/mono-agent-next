...
Source manifest digest: `a5690a79f88c4309f17b7d34ea7bc22146a56e423ba99e49cb96190a524fa980`

## Lines of code

| Classification | Files | Physical lines |
| --- | ---: | ---: |
| Production | 328 | 104469 |
| Tests | 178 | 90820 |
| Repository and product tooling | 59 | 20026 |
| Checked-in generated source | 0 | 0 |
| **Total executable source** | **565** | **215315** |
...
Average production file size is 318.5 lines.

## Binding budgets

| Budget | Actual | Maximum | Result |
| --- | ---: | ---: | --- |
| repository-production | 104469 | 130000 | within limit |
...
| --- | ---: | ---: | --- |
| test source, at 0.75 of production | 90820 | 78352 | within limit |
...
| `@mono-agent/service-macos` | 23 | 5929 | 2282 |
