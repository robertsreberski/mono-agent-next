...
The product of this refactor is a smaller system. The authoritative stacked clean-successor G0 baseline is 187,005 handwritten production-source lines across 536 files and 22 publishable packages; agent-app holds 70,510. Stable v1 ships at most 130,000 lines — the binding number, with a roadmap-rounded 30.48% reduction and 69.52% retained while the exact percentage remains report output rather than a second gate — and core + module-sdk + cli are capped at 15,000 lines. These are machine-tracked release gates.
...
The authoritative stacked clean-successor G0 baseline is 187,005 production-source lines across 536 files. Algorithm v1 reported 182,217, but its extension allowlist omitted product-bearing configuration, shipped skill resources, and reachable web assets. The fail-closed v2 universe adds the config schema (2,476 lines), shipped composer and Supermemory resources (1,553), and reachable web HTML/CSS/SVG (759): 13 files and 4,788 lines, so `182,217 + 4,788 = 187,005`. The exact snapshot also reports 180,248 test lines across 472 files and 36,728 excluded-with-evidence lines across 169 files, for 403,981 accounted lines across 1,177 files; generated, vendored, and unclassified totals are zero. Its snapshot digest is `ff1cb5900de51f954d68133295f26af8bc7572a99dc5e883afc6c905c201c313`, its classified-file manifest digest is `7c29e9894e498248cd2bb7d75d4253fd7100319cc9a0e10144eb70c2c6b7343f`, and its committed baseline-file digest is `18e8a2461abebcadd079dd9ce6f3de11df47842528688d3978d94ba81495f4f6`. V1-002 commits the stage-0 classifier, exact baseline, frozen classification authority, ratchetable inventory policy, and independently bound G0 authority artifact. Production reachability overrides test-looking paths; exact generated, vendored, and excluded evidence is digest-bound; catalog ownership is exact; unknown source fails closed. G0 requires an exact clean-HEAD reproduction. After merge, later gates require the protected annotated `refs/tags/authority/v1-complexity-g0` tag and cannot rewrite the frozen baseline or classification rules.
...
| Repository production source at G8 | ≤130,000 (binding); roadmap-rounded 30.48% reduction and 69.52% retained, with exact reduction reported |
...
| G8 — stable | Ledger green; source ≤130k (binding; roadmap-rounded 30.48% reduction, 69.52% retained); kernel ≤15k; clean-history release readiness; separately approved stable publish | Exact-SHA reports; packed consumer install; section 2.6 OSS and section 2.7 history checks green; clean public clone; post-launch dispositions |
...
| V1-002 | G0 | V1-001 | Commit fail-closed classifier, exact normalized baseline, and independently bound G0 authority | Clean-checkout digest/count reproduction; zero unclassified files; post-merge protected annotated authority ref |
